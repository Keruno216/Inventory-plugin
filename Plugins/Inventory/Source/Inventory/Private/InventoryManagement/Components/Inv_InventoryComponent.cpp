                                                                    ...
                                                                    int32 Remainder)
{
	...
	else if (FInv_StackableFragment* StackableFragment = ItemComponent->GetItemManifest().GetFragmentOfTypeMutable<
...
void UInv_InventoryComponent::SpawnDroppedItem(UInv_InventoryItem* Item, int32 StackCount)
{
	...
	RotatedForward = RotatedForward.RotateAngleAxis(FMath::FRandRange(DropSpawnAngleMin, DropSpawnAngleMax),
	                                                FVector::UpVector);
	FVector SpawnLocation = OwningPawn->GetActorLocation() + RotatedForward * FMath::RandRange(
...
void UInv_InventoryComponent::ConstructInventory()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("Inventory Component is Local Controller"));
